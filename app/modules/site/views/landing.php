<?php $this->load->view('site/header'); ?>
    <div class="page-header header-filter" data-parallax="active" style="background-image: url('<?php echo base_url('static/img/bg13.jpg')?>');">
        <div class="container">
            <div class="row">
                <div class="col-md-7">
...
<?php $this->load->view('site/no-footer-js'); ?>