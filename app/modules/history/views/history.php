                        ...
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                <tbody>
                                    <?php
                                        $i = 1; 
                                        $lessons = ['การแจ้งเหตุ 1669','การปฐมพยาบาลเบื้องต้น','การช่วยฟื้นคืนชีพเบื้องต้น','EMS Rally','EMS Rally post test',' อาการฉุกเฉินที่ควรโทรแจ้ง 1669 และอาการฉุกเฉินวิกฤตที่ส่งผลต่อชีวิตและอวัยวะสำคัญ '];
                                        foreach($objs as $row): 
                                    ?>
                                    <tr>
